...
datatype yystart_state = STRING | SPACE | COMMENT | INITIAL
...
fun yyAction2 (strm, lastMatch : yymatch) = (yystrm := strm;
      (CommentCount := 1; YYBEGIN COMMENT; continue()))
fun yyAction3 (strm, lastMatch : yymatch) = (yystrm := strm;
      (CommentCount := !CommentCount + 1; continue()))
...
fun yyAction48 (strm, lastMatch : yymatch) = (yystrm := strm;
      (StringState := 1; YYBEGIN STRING; StringIndex := yypos; StringBuffer := ""; continue()))
...
fun yyAction54 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (StringBuffer := !StringBuffer ^ asciiCode(yytext); continue())
      end
fun yyAction55 (strm, lastMatch : yymatch) = (yystrm := strm;
      (StringState := 0; YYBEGIN INITIAL; Tokens.STRING(!StringBuffer, !StringIndex, yypos)))
fun yyAction56 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN SPACE; continue()))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ60(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"h"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ70(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ72(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"a"
              ...
              then if inp = #"y"
                  then yyQ68(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
              else yyAction24(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ73(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"f"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ75(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ74(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ77(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ87(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ86(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ85(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ84(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ83(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"c"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ96(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
              else yyAction24(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ94(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ101(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ100(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
              else yyAction24(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ99(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ98(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ43(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
...
fun yyQ38 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction26(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ105(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
...
fun yyQ36 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction38(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ106(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
...
fun yyQ7 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction56(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\\"
              then yyQ10(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp < #"\\"
              then if inp = #"#"
              ...
              then if inp = #"n"
                  then yyQ11(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                  else yyAction56(strm, yyNO_MATCH)
            else if inp = #"t"
              then yyQ12(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
              else yyAction56(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\""
              ...
              then if inp = #"\n"
                  then yyAction49(strm, yyNO_MATCH)
                  else yyQ15(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp = #"\\"
              then yyAction49(strm, yyNO_MATCH)
              else yyQ15(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"\""
              ...
              then if inp = #"\n"
                  ...
                  else yyQ4(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp = #"\\"
              then yyQ7(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
              else yyQ4(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
      (* end case *))
in
  (case (!(yyss))
   of STRING => yyQ0(!(yystrm), yyNO_MATCH)
    | SPACE => yyQ1(!(yystrm), yyNO_MATCH)
