       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ58(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"h"
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ41(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ94(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ41(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
              else yyAction24(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ98(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ41(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
              else yyAction24(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ36 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction26(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ103(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
...
fun yyQ29 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction37(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              then yyQ105(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
       ...
       of NONE => yyAction50(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\""
              ...
              then if inp = #"\n"
                  then yyAction50(strm, yyNO_MATCH)
                  else yyQ15(strm', yyMATCH(strm, yyAction50, yyNO_MATCH))
            else if inp = #"\\"
              then yyAction50(strm, yyNO_MATCH)
              else yyQ15(strm', yyMATCH(strm, yyAction50, yyNO_MATCH))
      (* end case *))
       ...
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #"\""
              ...
              then if inp = #"\v"
                  then yyQ3(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
                else if inp < #"\v"
                  then if inp = #"\n"
                      then yyQ4(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
